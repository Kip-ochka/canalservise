...
function ExitIcon(props) {
  return (
    ...
    >
      ...
      <Path
        fill="#27569C"
        d="M61.484 26.898 47.429 15.304c-.241-.199-.465-.304-.725-.304-.564 0-1.093.504-1.093 1.468v6.892H27.609c-.846 0-1.609.836-1.609 1.833v5.973c0 .997.763 1.831 1.61 1.831h18v6.895c0 .964.53 1.538 1.095 1.538h-.02c.26 0 .514-.14.755-.339l14.048-11.61c.378-.311.592-.788.592-1.292 0-.503-.219-.98-.596-1.291z"
      />
    </Svg>
  );
}
